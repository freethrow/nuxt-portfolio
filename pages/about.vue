<template>
  <div>
    <div class="mt-8 mx-2 wrapper">
      ...
      <div
        id="bio"
        class="mx-auto p-5 container font-light lg:grid lg:gap-2 lg:grid-cols-3 lg:grid-flow-row-dense"
      >
        <BioComponent title="Obrazovanje" :content="bio.fields.education" />
        <BioComponent
          title="Radno iskustvo"
          :content="bio.fields.expirience"
          class="col-span-2"
        />
        <BioComponent
          title="Slikarstvo"
          :content="bio.fields.painting"
          class="col-span-2"
        />
        <BioComponent title="Arhitektura" :content="bio.fields.arhitektura" />
        <BioComponent
          title="Aktivnosti"
          :content="bio.fields.activities"
          class="col-span-2"
        />
